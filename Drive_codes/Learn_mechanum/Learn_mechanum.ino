...
//void abs_straigth(int v){
//    J1.s(j1_fact*(v+kp*dif*(-v)),kang_ramp);
//    J2.s(j2_fact*(v+kp*dif*(-v)),kang_ramp);
//    K1.s(k1_fact*(v+kp*dif*(v)),kang_ramp);
//    K2.s(k2_fact*(v+kp*dif*(v)),kang_ramp);
